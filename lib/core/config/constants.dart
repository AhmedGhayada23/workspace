class Constants {
  ...
  static const String baseUrl = 'https://mobile.spaces.areisto.com/api';
  static const String imageUrl = 'https://doorly.om/uploads/';
  static const String loginApi = '/v1/auth/login';
  static const String registerApi = '/v1/auth/register';
  static const String forgetPasswordSendCodeApi = '/v1/forget-password/send-code';
  static const String checkCodeActiveApi = '/v1/auth/check-code-for-activate';
  static const String checkCodeForgetPasswordApi = '/v1/forget-password/check-code';
  static const String sentCodeForDeleteAccountApi = '/v1/profile/send-code-for-delete-account';
  static const String chechCodeForDeleteAccountApi = '/v1/profile/check-code-for-delete-account';
  static const String forgetPasswordResetPasswordApi = '/v1/forget-password/reset-password';
  ...
  static const String readNotificationsApi = '/v1/notifications/mark-as-read-all';
